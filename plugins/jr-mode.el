...
;; List of keywords for JR. It's a hack to list all the keywords as c-modifiers-kwds, since many of them are not 
;; modifiers, but it works okay.
(c-lang-defconst c-modifier-kwds
  jr (append (list "inni" "remote" "as" "call" "cap" "forward" "handler" "noop" "on" "op" "over" "P" "receive" "remote" "reply" "send" "V" "view" "vm" "with") (c-lang-const c-modifier-kwds)))
